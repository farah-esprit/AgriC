...
import service.BrevoEmailService;
import service.CommandeService;
import service.ProduitService;
import service.StockService;
import service.StripePayment;
...
public class CommandeController {
    ...
    private void retourAccueil() {
        try {
            // ✅ Chercher le DashboardAgriculteurController parent
            Stage currentStage = (Stage) tfQuantite.getScene().getWindow();

            // Option 1 : Si chargé dans contentPane (recommandé)
            // Rien à faire, l'utilisateur cliquera sur "Dashboard" dans la sidebar

            // Option 2 : Si c'est une fenêtre séparée, retour à home.fxml
