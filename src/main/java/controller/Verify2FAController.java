    ...
    private void redirectToDashboard() {
        try {
            ...
            switch (currentUser.getRole()) {
                case AGRICULTEUR: fxmlFile = "/DashboardAgriculteur.fxml"; break;
                case EXPERT:      fxmlFile = "/DashboardAgriculteur.fxml";      break;
                case FOURNISSEUR: fxmlFile = "/home.fxml"; break;
