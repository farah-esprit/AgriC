...
public class ProfilService implements IService<Profil> {
    ...
    public void supprimer(int id) throws SQLException {
        ...
        try (Connection conn = MyDataBase.getConnection();
            ...
            System.out.println("✅ Rows supprimées : " + rows + " pour id=" + id); // ✅ si rows=0, l'ID n'existe pas

        } catch (SQLException e) {
            System.err.println("❌ Erreur SQL supprimer profil id=" + id + " : " + e.getMessage());
            throw e; // ✅ relancer pour que le controller la voit
        }
    }
    //AFFICHER
    @Override
