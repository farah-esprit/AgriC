...
public class DashboardFournisseurController {
    ...
    // ================= COMPTEURS =================
    @FXML private Label produitsCountLabel;
    ...
    @FXML private HBox menuStatistiques;
    @FXML private HBox menuParametres;
    ...
    public void initialize() {
        ...
        if (produitsCountLabel != null) produitsCountLabel.setText("0 produits");
        if (commandesCountLabel != null) commandesCountLabel.setText("0 en cours");
        if (stockCountLabel != null) stockCountLabel.setText("0 articles");
    ...
    public void setUser(User user) {
        ...
        System.out.println("✅ Utilisateur Fournisseur : " + user.getNom());
    }
    ...
    private void setActiveMenu(HBox activeMenuItem) {
        ...
        if (menuProduits != null) menuProduits.setStyle(defaultStyle);
        if (menuCommandes != null) menuCommandes.setStyle(defaultStyle);
        if (menuStock != null) menuStock.setStyle(defaultStyle);
        if (menuStatistiques != null) menuStatistiques.setStyle(defaultStyle);
        if (menuParametres != null) menuParametres.setStyle(defaultStyle);
    ...
    @FXML
    private void handleShowProduits(MouseEvent event) {
        setActiveMenu(menuProduits);
        showMessage("📦 Fonctionnalité Mes Produits en développement");
        System.out.println("📍 Mes Produits");
    }

    @FXML
    private void handleShowCommandes(MouseEvent event) {
        setActiveMenu(menuCommandes);
        showMessage("🛒 Fonctionnalité Commandes en développement");
        System.out.println("📍 Commandes");
    }

    @FXML
    private void handleShowStock(MouseEvent event) {
        setActiveMenu(menuStock);
        showMessage("📊 Fonctionnalité Gestion Stock en développement");
        System.out.println("📍 Gestion Stock");
    }

    @FXML
    private void handleShowStatistiques(MouseEvent event) {
        setActiveMenu(menuStatistiques);
        showMessage("📈 Fonctionnalité Statistiques en développement");
        System.out.println("📍 Statistiques");
    }

    @FXML
    private void handleShowParametres(MouseEvent event) {
        setActiveMenu(menuParametres);
        showMessage("⚙️ Fonctionnalité Paramètres en développement");
    ...
    private void handleGoToProfil(MouseEvent event) {
        try {
            ...
            System.out.println("✅ Profil Fournisseur chargé dans contentPane");
    ...
    public void reloadDashboardContent() {
        if (contentPane != null && originalDashboardContent != null) {
            ...
            System.out.println("✅ Dashboard Fournisseur restauré");
        }
        setActiveMenu(menuHome);
